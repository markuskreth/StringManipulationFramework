 ...
 * Der source-String (in {@link #replace(String)}) im format [+|-]###### entspricht dabei den millisekunden, die dem konfigurierten Calendar-Wert hinzugefügt werden.
 * Beispiel: +10000 fügt dem Calendar 10 Sekunden (10000ms) hinzu.
 * Beispiel: -20000 zieht 20 Sekunden ab.
 * Die Ausgabe wird durch das übergebene DateFormat formatiert.
 * 
 * @author markus
 */
public class CalendarReplacor implements ReplaceFunction {
   ...
   /**
    * 
    * @param time Zeitpunkt zu dem die Einheiten addiert werden.
    * @param df   Ausgabeformat des Calendar
    * @param field   Einheit, die addiert werden soll.
    */
